...
![an svg of a clock](<.gitbook/assets/example_clock (1).svg>)
...
![Outside-in feedback loops in TDD](<.gitbook/assets/TDD-outside-in (1).jpg>)
...
![picture of the unit circle](<.gitbook/assets/unit_circle (1).png>)
...
![picture of the unit circle with a point defined on the circumference](<.gitbook/assets/unit_circle_coords (1).png>)
...
![unit circle ray defined from by angle from y axis](<.gitbook/assets/unit_circle_12_oclock (1).png>)
...
![a clock with only a second hand](<.gitbook/assets/clock (3).svg>)
...
![a clock with second and minute hands](<.gitbook/assets/clock (1) (1).svg>)
...
![a clock](<.gitbook/assets/clock (2) (1).svg>)
