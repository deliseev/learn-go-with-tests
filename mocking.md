...
- При столкновении с менее тривиальными примерами разбивайте проблему на "тонкие вертикальные срезы". Старайтесь как можно скорее достичь точки, когда у вас есть _рабочее программное обеспечение, подкрепленное тестами_, чтобы избежать попадания в тупики и применения подхода "всё и сразу".
