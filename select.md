...
Вы помните из главы о параллелизме, что вы можете ожидать получения значения из канала с помощью `myVar := <-ch`. Это _блокирующий_ вызов, поскольку вы ждете значения.
