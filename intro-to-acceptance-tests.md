...
Когда мы писали пакет `gracefulshutdown`, у нас были юнит-тесты, чтобы доказать, что он ведет себя корректно, что дало нам уверенность в агрессивном рефакторинге. Однако мы всё ещё не чувствовали себя «уверенными» в том, что он **действительно** работает.
